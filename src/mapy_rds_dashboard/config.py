...
config["rds_operations_cmf_paths"] = [
    ...
    Path("Shared drives/prepared-country-data/iraq"),
    ...
    Path("Shared drives/prepared-country-data/antigua-and-barbuda"),
    Path("Shared drives/prepared-country-data/zimbabwe"),
    Path("Shared drives/prepared-country-data/syria"),
    Path("Shared drives/prepared-country-data/sudan"),
    Path("Shared drives/prepared-country-data/ethiopia"),
    ...
    Path("Shared drives/prepared-country-data/chad"),
    Path("Shared drives/prepared-country-data/madagascar"),
    Path("Shared drives/prepared-country-data/cambodia"),
    Path("Shared drives/prepared-country-data/taiwan"),
    Path("Shared drives/prepared-country-data/senegal"),
    Path("Shared drives/prepared-country-data/burkina-faso"),
    Path("Shared drives/prepared-country-data/vietnam"),
]
